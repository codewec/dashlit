...
features:
  ...
  - icon: 🎨
    ...
    details: Выбирайте встроенные темы или создавайте собственную палитру с нужными цветами и фоном, используйте чистый режим и широкую раскладку.
  - icon: ✨
    title: Иконки для любой темы
    details: Ищите одновременно в selfh.st и Iconify. DashLit автоматически подбирает светлую и тёмную версии selfh.st и сохраняет читаемость монохромных Iconify-иконок.
  - icon: ⌨️
    title: Управление с клавиатуры
    details: Начинайте фильтрацию вводом, перемещайтесь по дашборду стрелками и назначайте сочетания клавиш ссылкам и своим дашбордам.
  - icon: 📦
